...
$bulan       = mysqli_query($koneksi, "SELECT bulan FROM discribe WHERE tahun='2016' order by id asc");
$penghasilan = mysqli_query($koneksi, "SELECT hasil_penjualan FROM discribe WHERE tahun='2016' order by id asc");
?>
<html>
    <head>
